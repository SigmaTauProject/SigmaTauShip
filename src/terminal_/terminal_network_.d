module terminal_.terminal_network_;
...
class TerminalNetworkMaster {
	this() {
		...
		void main() {
			...
			router.get("/gzip/*", serveStaticFiles("../terminal/public", fileServerSettings));
			router.get("*", serveStaticFiles("../terminal/public", fileServerSettings));
